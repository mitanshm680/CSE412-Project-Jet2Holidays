...
- remove or update the old `FlightManagementSystem/src/README.md` (I will move it out as part of this change), or
- keep a short README copy inside `FlightManagementSystem/` that points to this top-level README.

---

README created by the repository maintainer scripts to centralize setup and run instructions.
